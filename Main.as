package 
{
	...
	public class Main extends Screen
	{
		...
		private var contentPanelLayoutdata;
		...
		private function initializeHandler(e:Event):void
		{
			...
			bgTexture = atlas.getTexture("spriteSheetTextures");
			...
			this.button.addEventListener(Event.TRIGGERED, play_Button_Triggered);
			this.buttonPanel.addChild(this.button);
			
			
			assetMgr = new AssetManager();
			
			assetMgr.verbose = true;   //change to false when done
		...
		{
			bgImgLoader.source = atlas.getTexture("spriteSheetTextures");
		}
		
		private function play_Button_Triggered(event:Event):void
		{
			trace("button clicked");
			assetMgr.playSound("Song");
		}
